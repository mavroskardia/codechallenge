...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Coder.level'
        db.delete_column('coder_coder', 'level_id')


    def backwards(self, orm):
        # Adding field 'Coder.level'
        db.add_column('coder_coder', 'level',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['coder.Level']),
                      keep_default=False)
    ...
    models = {
        ...
        'coder.coder': {
            ...
            'challenges': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['challenge.Challenge']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
