...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Coder.level'
        db.alter_column(u'coder_coder', 'level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coder.Level'], null=True))

    def backwards(self, orm):

        # Changing field 'Coder.level'
        db.alter_column(u'coder_coder', 'level_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['coder.Level']))
