...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChallengeComment.date'
        db.alter_column('challenge_challengecomment', 'date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'ChallengeComment.date'
        db.alter_column('challenge_challengecomment', 'date', self.gf('django.db.models.fields.DateField')())
