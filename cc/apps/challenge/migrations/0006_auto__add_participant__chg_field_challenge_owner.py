...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('challenge_participant', (
        ...
        db.send_create_signal('challenge', ['Participant'])


        # Changing field 'Challenge.owner'
        db.alter_column('challenge_challenge', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenge.Participant']))

    def backwards(self, orm):
        # Deleting model 'Participant'
        db.delete_table('challenge_participant')


        # Changing field 'Challenge.owner'
        db.alter_column('challenge_challenge', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coder.Coder']))
    ...
    models = {
        ...
        'challenge.challenge': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'owner'", 'to': "orm['challenge.Participant']"})
        },
