...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('challenge_challenge', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coder.Coder'], default=self.get_default_owner),
                      keep_default=False)
    ...
    models = {
        ...
        'coder.coder': {
            ...
            'challenges': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'blank': 'True', 'to': "orm['challenge.Challenge']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
