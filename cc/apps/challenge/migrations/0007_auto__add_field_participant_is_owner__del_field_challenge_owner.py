...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.is_owner'
        db.add_column('challenge_participant', 'is_owner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Challenge.owner'
        db.delete_column('challenge_challenge', 'owner_id')


    def backwards(self, orm):
        # Deleting field 'Participant.is_owner'
        db.delete_column('challenge_participant', 'is_owner')


        # User chose to not deal with backwards NULL issues for 'Challenge.owner'
        raise RuntimeError("Cannot reverse this migration. 'Challenge.owner' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Challenge.owner'
        db.add_column('challenge_challenge', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='owner', to=orm['challenge.Participant']),
                      keep_default=False)
