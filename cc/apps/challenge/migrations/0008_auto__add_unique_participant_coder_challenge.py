...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Participant', fields ['coder', 'challenge']
        db.create_unique('challenge_participant', ['coder_id', 'challenge_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Participant', fields ['coder', 'challenge']
        db.delete_unique('challenge_participant', ['coder_id', 'challenge_id'])
