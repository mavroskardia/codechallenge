...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChallengeComment'
        db.create_table('challenge_challengecomment', (
        ...
        db.send_create_signal('challenge', ['ChallengeComment'])


    def backwards(self, orm):
        # Deleting model 'ChallengeComment'
        db.delete_table('challenge_challengecomment')
