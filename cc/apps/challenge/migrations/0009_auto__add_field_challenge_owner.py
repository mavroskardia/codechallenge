...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'challenge_challenge', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=self.get_default_owner, to=orm['coder.Coder']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.owner'
        db.delete_column(u'challenge_challenge', 'owner_id')
